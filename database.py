...
# Use cloud MongoDB URI if available, fallback to local
MONGODB_URL = os.getenv("MONGODB_URI") or os.getenv("MONGO_URI") or os.getenv("MONGODB_URL", "mongodb://localhost:27017/")
